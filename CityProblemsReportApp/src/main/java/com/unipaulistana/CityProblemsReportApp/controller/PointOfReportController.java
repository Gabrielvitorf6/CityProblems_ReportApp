...
@RestController
@RequestMapping("/api/pointsofreports")
...
public ResponseEntity<List<PointOfReport>> findByTitleLike(@PathVariable String title){
    ...
    @GetMapping("/pointofreporttag/{pointOfReportTagID}")
    ...
    @PostMapping
    public ResponseEntity<PointOfReport> createPointOfReport (@RequestBody PointOfReport pointOfReport){
        return new ResponseEntity<>(this.pointOfReportService.create(pointOfReport), HttpStatus.CREATED);
    }
